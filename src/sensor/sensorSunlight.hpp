...
//     uint16_t regist; // Included  variable for SI115X to work with sensorSunLight : Author simon.martinez@uantof.cl
...
// {
//     uint16_t t_reg = reg;
//     regist = t_reg; // Included  variable for SI115X to work with sensorSunLight : Author simon.martinez@uantof.cl
...
//     float IR = _si1151.ReadHalfWord(regist);
//     float VLR = _si1151.ReadVisible();
//     float UV = _si1151.ReadUV();
